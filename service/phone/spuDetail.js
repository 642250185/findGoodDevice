...
const getSku = async(phoneQuality) => {
    try {
        ...
        const {key_prop_type, key_prop_rs} = result_keyprop_detail.data;
        for(let propRs of key_prop_rs){
            for(let propRsItem of propRs){
                console.info(phoneQuality.productId, phoneQuality.modelName, propRsItem.pn_name, propRsItem.pv_name, propRsItem.pn_id, propRsItem.pv_id);
                list.push({
                    productId: phoneQuality.productId,
                    modelName: phoneQuality.modelName,
...
const getSpuDetail = async(phoneQuality) => {
    try {
        ...
        spusDetailList.push({
            ...
            spuName: phoneQuality.modelName,
